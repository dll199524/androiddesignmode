...
public class StatusBarUtil {
    ...
    private static final int DEFAULT_ALPHA_NO_TRANSPARENT = 0;
    ...
    public static void setColorNoTranslucent(Activity activity, @ColorInt int color) {
        setColor(activity, color, DEFAULT_ALPHA_NO_TRANSPARENT);
    }
